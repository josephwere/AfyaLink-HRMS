...
overtimeRequestSchema.index({ hospital: 1, status: 1, createdAt: -1 });
overtimeRequestSchema.index({ hospital: 1, requester: 1, status: 1, createdAt: -1 });
overtimeRequestSchema.index({ hospital: 1, date: -1, createdAt: -1 });
overtimeRequestSchema.index({ hospital: 1, status: 1, escalationLevel: 1, createdAt: -1 });

export default model("OvertimeRequest", overtimeRequestSchema);
