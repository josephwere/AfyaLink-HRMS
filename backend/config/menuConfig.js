export const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Revenue Intelligence", path: "/system-admin/revenue-intelligence", icon: "analytics" },
      { label: "Clinical Order Copilot", path: "/system-admin/clinical-order-copilot", icon: "ai" },
      { label: "Digital Hospital Twin", path: "/system-admin/digital-hospital-twin", icon: "analytics" },
      { label: "Interop Marketplace", path: "/system-admin/interop-marketplace", icon: "settings" },
    ],
  },
  {
    section: "Workforce",
...

  {
    ...
    items: [
      ...
      { label: "Clinical Order Copilot", path: "/hospital-admin/clinical-order-copilot", icon: "ai" },
      { label: "Digital Twin", path: "/hospital-admin/digital-twin", icon: "analytics" },
      { label: "Interop Marketplace", path: "/hospital-admin/interop-marketplace", icon: "settings" },
...

  {
    ...
    items: [
      ...
      { label: "Family Timeline", path: "/patient/family-timeline", icon: "analytics" },
