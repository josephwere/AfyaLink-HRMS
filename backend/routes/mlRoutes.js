...
router.post('/staffing/forecast', protect, permit('SUPER_ADMIN', 'SYSTEM_ADMIN', 'HOSPITAL_ADMIN', 'HOSPITAL_ADMIN_ASSISTANT', 'HR_MANAGER', 'DEVELOPER'), abacGuard({ domain: "AI", resource: "clinical_intelligence", action: "read", fallbackAllow: true }), staffingForecast);
