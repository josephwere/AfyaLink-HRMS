...
- Name: permissions.spec.ts >> AfyaLink Permission and Auth Access Control tests >> Super Admin should be allowed access to System Settings
- Location: tests/e2e/permissions.spec.ts:28:7
