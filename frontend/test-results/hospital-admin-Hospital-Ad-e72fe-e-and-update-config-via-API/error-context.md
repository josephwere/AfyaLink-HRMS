...
- Name: hospital-admin.spec.ts >> Hospital Admin configuration workflows >> should load facility customization page and update config via API
- Location: tests/e2e/hospital-admin.spec.ts:13:7
