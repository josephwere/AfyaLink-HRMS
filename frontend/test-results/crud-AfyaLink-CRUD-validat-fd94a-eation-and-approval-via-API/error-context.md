...
- Name: crud.spec.ts >> AfyaLink CRUD validations >> Laboratory result creation and approval via API
- Location: tests/e2e/crud.spec.ts:294:7
...
Call log:
  - → POST http://127.0.0.1:5000/api/auth/login
    - user-agent: Playwright/1.61.1 (x64; ubuntu 24.04) node/25.6
    - accept: */*
