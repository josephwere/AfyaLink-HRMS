...
- Name: notifications.spec.ts >> AfyaLink Notifications system tests >> should display notifications page and manage read status
- Location: tests/e2e/notifications.spec.ts:13:7
