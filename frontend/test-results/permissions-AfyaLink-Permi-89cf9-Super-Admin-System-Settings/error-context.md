...
- Name: permissions.spec.ts >> AfyaLink Permission and Auth Access Control tests >> Nurse should be blocked from Super Admin System Settings
- Location: tests/e2e/permissions.spec.ts:13:7
