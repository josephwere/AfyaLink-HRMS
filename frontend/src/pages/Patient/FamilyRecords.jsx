...
import { usePatientFamilyRecords } from "../../hooks/usePatientFamilyRecords";

export default function FamilyRecords() {
  const navigate = useNavigate();
  const { t } = usePatientLanguage();
  const { family, encounters, reports, profile, hospitals, registerBusy, msg, setMsg, registerForm, setRegisterForm, registerMinor, totals, familyPolicyMap } = usePatientFamilyRecords();
