    ...
    <div className="dashboard">
      ...
      <section className="section">
        <div className="card premium-card">
          ...
          <input type="number" min={1} max={300} value={radiusKm} onChange={(e) => setRadiusKm(Number(e.target.value || 25))} />
      ...
      <section className="section">
        <div className="card premium-card">
          ...
          <select value={selectedPharmacyId} onChange={(e) => setSelectedPharmacyId(e.target.value)} disabled={!locationReady || loading}>
      ...
      <section className="section">
        <form className="card premium-card" onSubmit={submitReferral}>
          ...
          <input value={form.reason} onChange={(e) => setForm((p) => ({ ...p, reason: e.target.value }))} placeholder="Medication unavailable in hospital" />

          <label>Medication / notes</label>
          <textarea rows={4} value={form.medicationNotes} onChange={(e) => setForm((p) => ({ ...p, medicationNotes: e.target.value }))} />
