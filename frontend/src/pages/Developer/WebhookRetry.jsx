    ...
    <div className="dashboard developer-console-page">
      <section className="welcome-panel premium-card developer-console-hero">
        <div className="developer-console-hero-copy">
          ...
          <h2>Webhook Retry</h2>
          <p className="muted">Retry failed connector deliveries from a cleaner premium webhook operations view.</p>
          <div className="welcome-actions">
            <button type="button" className="btn-primary" onClick={load} disabled={loading}>
              {loading ? "Refreshing..." : "Refresh Webhook Queue"}
            </button>
        ...
        <div className="developer-console-hero-meta">
          <div className={`developer-console-pulse ${items.length > 0 ? "warn" : "good"}`}>
            ...
            <small>Connector events currently waiting for retry.</small>
          </div>
          ...
          <div className={`developer-console-pulse ${summary.highAttempt > 0 ? "risk" : "good"}`}>
            <span>High-attempt retries</span>
            <strong>{summary.highAttempt}</strong>
            <small>Events already retried three or more times.</small>
          </div>
          <div className="developer-console-pulse neutral">
      ...
      <section className="section developer-console-grid">
        <div className="card premium-card developer-console-table-card">
          <div className="card-header-actions">
            <div>
              <h3>Webhook Queue</h3>
              <p className="muted">A cleaner list of failed webhook payloads, retry posture, and connector context.</p>
            </div>
                  ...
                  <tr>
                    <td colSpan="5">
                      <div className="developer-empty-state compact">
                        <strong>No webhook retries queued.</strong>
          ...
          <div className="card premium-card developer-console-sidecard">
            <div className="card-header-actions">
              <div>
                ...
                <p className="muted">See which connectors are generating the highest retry pressure.</p>
              </div>
            </div>
            <div className="developer-activity-list">
              {connectorLeaders.map((entry) => (
                <div key={entry.connector} className="developer-activity-item">
                  <div>
                    ...
                    <p className="muted">Queued webhook retries</p>
                  </div>
              ...
              {!connectorLeaders.length && (
                <div className="developer-empty-state compact">
                  ...
                  <p className="muted">Connector pressure will show up here as soon as retries start stacking.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="card premium-card developer-console-sidecard">
            <div className="card-header-actions">
              <div>
                ...
                <p className="muted">Keep retry work disciplined, especially when a connector is flapping.</p>
              </div>
            </div>
            <div className="developer-runbook-list">
              ...
              <div className="developer-runbook-item"><strong>Escalate repeated flaps</strong><p className="muted">High-attempt items usually mean the issue is structural, not a one-off retry miss.</p></div>
            </div>
          </div>
        </div>
      </section>
